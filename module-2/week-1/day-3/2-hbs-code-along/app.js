...
app.get('/boston-players', (request, response, next) => {
  const bostonPlayers = players.filter(player => player.team === "BOS");
  const data = { players: bostonPlayers };
  response.render('boston', data);
})
